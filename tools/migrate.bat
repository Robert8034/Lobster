...
set MIGRATIONS_PATH=%~dp0..\Lobster.Data\Migrations
...
rem Move the current directory to the parent directory which is the data project that contains LobsterContext.cs which it will need for the command below
cd %MIGRATIONS_PATH%\..\

rem The dotnet command for creating migrations for the current directory
dotnet ef migrations add InitialCreate --context LobsterContext
